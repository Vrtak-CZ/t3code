...
describe("buildProjectActionItems", () => {
  it("includes the project environment name in search terms", () => {
    const items = buildProjectActionItems({
      projects: [
        {
          ...makeProject({ title: "PC", workspaceRoot: "/Users/vrtak-cz/Code/Temp/PC" }),
    ...
    expect(items[0]?.searchTerms).toEqual(["PC", "/Users/vrtak-cz/Code/Temp/PC", "This device"]);
    expect(items[0]?.description).toBe("/Users/vrtak-cz/Code/Temp/PC");
